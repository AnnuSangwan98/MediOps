    ...
    // Function to generate a password that meets the database constraints
    private func generateCompliantPassword() -> String {
        // Create a password that meets the format: length >= 8 AND contains at least one letter and one digit
        let length = 12 // Using a longer password for security
    ...
    private func handleSubmit() {
        ...
        Task {
            do {
                ...
                // Generate a compliant password that meets database requirements
                let securePassword = generateCompliantPassword()
                ...
                let emailDetails = EmailDetails(
                    ...
                    adminPhone: phone,
                    password: securePassword  // Use our generated password
                )
                ...
                print("Using password that meets database constraints:", securePassword)
                ...
                // Create hospital data with the provided hospitalID and our generated compliant password
                let hospitalData = HospitalData(
                    ...
                    password: securePassword  // Use our generated compliant password
                )
                ...
                // Create admin data using the same hospitalID and our generated compliant password
